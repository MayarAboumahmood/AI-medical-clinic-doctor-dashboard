class AppString {
  ...
  static String joinUs = 'Join our community and unlock exclusive features';
  static String welcomBack = 'Welcome Back! Log In To Continue';
  ...
  static String validatLenghtPassword =
      "Your password should be at least 8 character";
  ...
  static String validationDropDownEmpty = "You have to choose";
  ...
  static String longRestaurantDEscription =
  ...
  static String changePasswordTitle =
      'Your password should be at least 6 characters and should include a combination of numbers, letters and special characters (!\$@%)';
  ...
  static String disclaimerAndLimitations =
